...
public class UIDragObjectEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		EditorGUI.BeginDisabledGroup(sp.objectReferenceValue == null);
		{
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("min", GUILayout.Width(78f));
            NGUIEditorTools.DrawPaddedProperty("", serializedObject, "min");
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label("max", GUILayout.Width(78f));
            NGUIEditorTools.DrawPaddedProperty("", serializedObject, "max");
            GUILayout.EndHorizontal();
        }
